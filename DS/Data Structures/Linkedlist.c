...
switch(choice)
 {
  ...
  case 6:printf("Enter the position:\n");
		...
		break; 
  case 7:printf("Enter the item to be inserted in ordered_list\n");
        scanf("%d",&item);
  ...
  case 13:count=length(first);
        printf("Length(items) in the list is %d\n",count);
        break;
  case 14:printf("Enter the item to be searched\n");
        scanf("%d",&key);
        search(key,first);
        break;      
 default:exit(0);
